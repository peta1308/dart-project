...
void main() {
  ...
  try {
    hotel.hacerCheckIn(numeroHabitacion: 101, cantidadPersonas: 5);
    print("Error en T09: Debió fallar por exceder la capacidad");
  } catch (e) {
    print(
        "Prueba T09 Exitosa: Excepción capturada correctamente (${e.toString()})");
  }
}
